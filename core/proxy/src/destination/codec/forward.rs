use crate::crypto::ProxyForwardRsaCryptoHolder;
...
pub struct ForwardDestinationTransportControlPacketCodec {
    agent_control_packet_encoder: AgentControlPacketEncoder<ProxyForwardRsaCryptoHolder>,
    proxy_control_packet_decoder: ProxyControlPacketDecoder<ProxyForwardRsaCryptoHolder>,
}

impl ForwardDestinationTransportControlPacketCodec {
    pub fn new(
        forward_auth_token: String,
        rsa_crypto_holder: Arc<ProxyForwardRsaCryptoHolder>,
    ) -> Self {
        Self {
